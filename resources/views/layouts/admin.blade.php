                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div style="width: 500px; height: 60px;" class="alert alert-info" role="alert" {{Session::has('flash_message_important' ? 'alert_important' : '' )}}>
