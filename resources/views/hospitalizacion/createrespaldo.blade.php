  ...
  $("#guardar").hide();
   ...
   function agregar(){
    ...
    if (idcama!="" && cantidad!="") {
      ...
      var fila='<tr class"selected" id="fila'+cont+'"><td><button type="button" class="btn btn-warning" onclick="eliminar('+cont+');">x</button></td><td><input type="hidden" name="idcama[]" value="'+idcama+'">'+cama+'</td><td><input type="hidden" name="idpatologian[]" value="'+idpatologian+'">'+patologia+'</td><td><input type="text" name="observacion[]" value="'+observacion+'"></td></tr>';
