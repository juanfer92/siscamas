...
<section class="content-header">
    <h3><i class="fa fa-puzzle-piece" aria-hidden="true"></i>Listado Encuestas Pendientes {{-- @can('encuesta.create')
        <a href="{{ route('encuesta.create') }}"> <button class="btn btn-success btn-xs"><i class="fa fa-plus-circle" aria-hidden="true"></i> &nbsp Nuevo</button></a>        @endcan --}}
    </h3>
    <ol class="breadcrumb">
        ...
        <div id="ID" class="table-responsive">
            <table class="table table-striped table-bordered table-condensed table-hover">
                ...
                <tr>
                    ...
                    <td>
                        @can('encuesta.edit')
                        <a href="{{route('encuesta.edit',$pre->ID_PACIENTE)}}" target="_blank"> <button class="btn btn-success"><i class="fa fa-external-link" aria-hidden="true"></i></button></a>                        @endcan
                    </td>
                </tr>
