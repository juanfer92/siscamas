...
<section class="content-header">
 <h3>Listado de Pacientes
  @can('paciente.create')
          <a href="{{ route('paciente.create') }}"> <button class="btn btn-success btn-xs"><i class="fa fa-plus-circle" aria-hidden="true"></i> &nbsp Nuevo</button></a>
        ...
        <div class="table-responsive">
          ...
          <table class="table table-striped table-bordered table-condensed table-hover">
            <thead>
              ...
              <th bgcolor= "#fbd341">Fecha Ingreso</th>
              <th bgcolor= "#fbd341">Fecha Ingreso</th>
            ...
            <tr>
              ...
              <td>{{ $pac->NOM_PACIENTE.' '.$pac->NOM_PACIENTE1}}</td>
              <td>{{ $pac->APE_PACIENTE.' '.$pac->APE_PACIENTE1}}</td>
              ...
              <td>
                ...
                @endcan
                @can('paciente.edit')
                <a href="{{route('paciente.edit',$pac->ID_PACIENTE)}}"> <button class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                @endcan
                {{-- @can('paciente.destroy')
                <a href="" data-target="#modal-delete-{{$pac->ID_PACIENTE}}" data-toggle="modal"> <button class="btn btn-danger" title="Deshabilitar">
