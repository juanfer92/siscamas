    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="form-group">
            <label>
              ...
              <select class="form-control selectpicker" data-live-search="true" name="idtipocama">
        ...
        <div class="form-group">
            <label>
              ...
              <select class="form-control selectpicker" data-live-search="true" name="idestadocama">
    ...
    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
                ...
                <input class="form-control" id="codigobar" name="codigo" placeholder="Código de cama..." type="text" value="{{ old('codigo')}}">
                    <br>
