    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
                ...
                <input class="form-control" id="codigobar" name="codigo" placeholder="Código del artículo..." required="" style="text-transform: uppercase;" type="text" value="{{$camas->COD_CAMA}}">
                    <br>
